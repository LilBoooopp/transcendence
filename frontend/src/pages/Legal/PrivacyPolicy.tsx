    ...
    <div className="max-w-4xl mx-auto py-8 px-4">
      ...
      <div className="space-y-6 text-gray-700 dark:text-gray-300">
        <section>
          ...
          <p>
            When you register and use the Chess 42 platform, we collect information necessary to provide you with the services. This includes:
          </p>
          <ul className="list-disc pl-6 mt-2 space-y-1">
            <li><strong>Account Information:</strong> Your chosen username, email address, and authentication credentials.</li>
            <li><strong>Gameplay Data:</strong> Match history, win/loss records, Elo ratings, and in-game statistics.</li>
            <li><strong>Social Data:</strong> Your friends list, and public profile data.</li>
          </ul>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc pl-6 mt-2 space-y-1">
            ...
            <li>To provide social features, such as managing your friends list.</li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p className="mt-2">
            We implement standard security measures, including secure socket layer (SSL) technology and JWT-based authentication, to protect your data against unauthorized access or disclosure.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            You have the right to access the data we store about you and request its deletion. If you wish to delete your account or retrieve your data, please contact the site administrators or use the account delete features provided in your user profile.
          </p>
        </section>
      </div>
    </div>
